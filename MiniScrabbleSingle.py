    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while calculateHandlen(hand) > 0:
        ...
        if attempt == ".":
            ...
            if isValidWord(attempt, hand, wordList):
                points += getWordScore(attempt, n)
                print('" '+ attempt + ' "' + " earned " + str(getWordScore(attempt, n)) + "  points. Total:  " + str(points) + "  points\n")
...
def playGame(wordList):
    ...
    while True:
        ...
        if message == 'r':
            ...
            previous_hand = current_hand.copy()
        elif message == "e":
            break
        else:
